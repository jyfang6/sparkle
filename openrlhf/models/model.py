...
from .model_kg_adaptive_rag import get_kg_adaptive_critic_model
...
def get_llm_for_sequence_regression(
    ...
    **kwargs,
    ...
    """
    assert (
        model_type == "critic" or model_type == "reward" or model_type == "kg_adaptive_critic"
    ), f"invalid model_type: {model_type}, should be critic or reward or kg_adaptive_critic."
    ...
    elif model_type == "kg_adaptive_critic":
        cls_class = get_kg_adaptive_critic_model(model_name_or_path, base_pretrained_class, base_class, value_head_prefix, packing_samples)
